...
class Model(nn.Module):
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        #kwargs['conf'] = 0.5  # ByteTrack-based method needs low confidence predictions as input
        kwargs['mode'] = 'track'
    ...
    def export(self, **kwargs):
        ...
        custom = {'imgsz': self.model.args['imgsz'], 'batch': self.model.args['batch'], 'data': None, 'verbose': False}  # method defaults
