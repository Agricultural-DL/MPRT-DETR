...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.distill_layers = [1, 2, 3, 4, 12, 15, 18, 21]
        # ------------------------------Add-Param-End-----------------
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                with torch.cuda.amp.autocast(self.amp):
                    ...
                    self.loss, self.loss_items,pred_s = self.model(batch, epoch=epoch)

                   # _,_,pred_s= self.model(batch)
                    ...
                    if self.model_t is not None:
                        ...
                        with torch.no_grad():
                            ...
                            self.losst, self.loss_itemst, pred_t_offline = self.model(batch, epoch=epoch)
                        ...
                        if self.distillonline:
                            self.model_t.train()
                            self.loss3, self.loss_items3, pred_t_online = self.model(batch, epoch=epoch)
                            ...
                            self.teacherloss,_,_ = self.model_t(batch, pred_t_online)
