...
__all__ = ['EMA', 'BottleNeck_EMA', 'BasicBlock_EMA','EMA_attentionC3']

###################### EMA_attention  ####     START   by  AI&CV  ###############################

import torch
from torch import nn
from ..modules import Conv, LightConv
...
class HGBlock_EMA_attention(nn.Module):
    """
    ...
    def __init__(self, c1, cm, c2, k=3, n=6, lightconv=False, shortcut=False, act=nn.ReLU()):
        ...
        self.attention = EMA_attention(c1 + n * cm)
...
class EMA_attentionC3(nn.Module):
    """Rep C3."""
    ...
    def __init__(self, c1, c2, n=3, e=1.0):
        ...
        self.m = nn.Sequential(*[EMA_attention(c_) for _ in range(n)])
